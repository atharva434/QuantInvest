"""
Django settings for quantedgeapi project.
...
SECRET_KEY = 'django-insecure-8xh7y7xediaub$7-qc9^4ug0w$#!rkbaceyui=ztbi$q*yhdj('
...
ROOT_URLCONF = 'quantedgeapi.urls'
...
WSGI_APPLICATION = 'quantedgeapi.wsgi.application'
