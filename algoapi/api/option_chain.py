...
def save_optionchain(breeze, stock_info, expiry_date, base_ltp, right):
    import logging
    from datetime import datetime
    ...
    try:
        ...
        option_chains = get_option_chain(breeze, stock_code,right=right ,expiry_date=expiry_date)
        json.dumps(option_chains, )
